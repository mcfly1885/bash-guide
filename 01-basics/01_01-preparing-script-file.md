...
Like everyone else program languages, a bash script is written in text a file.

The file can have and extension `.sh` but It's not mandatory: linux will execute the script anyway because it can recognize that the file is a script. How?
